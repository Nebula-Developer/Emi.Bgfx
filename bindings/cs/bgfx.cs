...
[Flags]
public enum BgfxDebugFlags : uint {
	/// <summary>
	/// No debug.
	/// </summary>
	None                   = 0x00000000,
...
public enum TopologyConvertFlags {
	/// <summary>
...
public unsafe struct RendererResolution {
...
public unsafe struct BgfxInitConfig {
	public unsafe struct Limits {
	...
	public RendererResolution resolution;
	public Limits limits;
...
public static partial class Bgfx {
	...
	public static extern unsafe void AttachmentInit(Attachment* _this, TextureHandle _handle, Access _access, ushort _layer, ushort _numLayers, ushort _mip, byte _resolve);
	...
	public static extern unsafe uint WeldVertices(void* _output, VertexLayout* _layout, void* _data, uint _num, bool _index32, float _epsilon);
	...
	public static extern unsafe uint TopologyConvert(TopologyConvertFlags _conversion, void* _dst, uint _dstSize, void* _indices, uint _numIndices, bool _index32);
	...
	public static extern unsafe IntPtr GetRendererName(RendererType _type);
	...
	public static extern unsafe void InitCtor(BgfxInitConfig* _init);
	...
	public static extern unsafe bool Init(BgfxInitConfig* _init);
	...
	public static extern unsafe void DbgTextClear(byte _attr, bool _small);
	...
	public static extern unsafe uint GetAvailTransientIndexBuffer(uint _num, bool _index32);
	...
	public static extern unsafe void AllocTransientIndexBuffer(TransientIndexBuffer* _tib, uint _num, bool _index32);
	...
	[return: MarshalAs(UnmanagedType.I1)]
	public static extern unsafe bool AllocTransientBuffers(TransientVertexBuffer* _tvb, VertexLayout* _layout, uint _numVertices, TransientIndexBuffer* _tib, uint _numIndices, bool _index32);
	...
	[return: MarshalAs(UnmanagedType.I1)]
	public static extern unsafe bool IsFrameBufferValid(byte _num, Attachment* _attachment);
	...
	public static extern unsafe TextureHandle CreateTexture_2d(ushort _width, ushort _height, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
	...
	public static extern unsafe TextureHandle CreateTexture_2dScaled(BackbufferRatio _ratio, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags);
	...
	public static extern unsafe TextureHandle CreateTexture_3d(ushort _width, ushort _height, ushort _depth, bool _hasMips, TextureFormat _format, ulong _flags, Memory* _mem);
	...
	public static extern unsafe void UpdateTexture_2d(TextureHandle _handle, ushort _layer, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
	...
	public static extern unsafe void UpdateTexture_3d(TextureHandle _handle, byte _mip, ushort _x, ushort _y, ushort _z, ushort _width, ushort _height, ushort _depth, Memory* _mem);
	...
	public static extern unsafe void SetPaletteColorRgba32f(byte _index, float _r, float _g, float _b, float _a);
	...
	public static extern unsafe void SetViewName(ushort _id, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	public static extern unsafe void ResetView(ushort _id);
	...
	public static extern unsafe void EncoderSetMarker(Encoder* _this, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	public static extern unsafe void EncoderSetCondition(Encoder* _this, OcclusionQueryHandle _handle, bool _visible);
	...
	public static extern unsafe void EncoderSetStencil(Encoder* _this, uint _fstencil, uint _bstencil);
	...
	public static extern unsafe void EncoderSetVertexBuffer(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	...
	public static extern unsafe void EncoderSetVertexBufferWithLayout(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	public static extern unsafe void EncoderSetDynamicVertexBuffer(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	...
	public static extern unsafe void EncoderSetDynamicVertexBufferWithLayout(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	public static extern unsafe void EncoderSetTransientVertexBuffer(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices);
	...
	public static extern unsafe void EncoderSetTransientVertexBufferWithLayout(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	public static extern unsafe void EncoderSubmit(Encoder* _this, ushort _id, ProgramHandle _program, uint _depth, byte _flags);
	...
	public static extern unsafe void EncoderSubmitOcclusionQuery(Encoder* _this, ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, byte _flags);
	...
	public static extern unsafe void EncoderSubmitIndirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, uint _start, uint _num, uint _depth, byte _flags);
	...
	public static extern unsafe void EncoderSubmitIndirectCount(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, uint _start, IndexBufferHandle _numHandle, uint _numIndex, uint _numMax, uint _depth, byte _flags);
	...
	public static extern unsafe void EncoderDispatch(Encoder* _this, ushort _id, ProgramHandle _program, uint _numX, uint _numY, uint _numZ, byte _flags);
	...
	public static extern unsafe void EncoderDispatchIndirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, uint _start, uint _num, byte _flags);
	...
	public static extern unsafe void EncoderDiscard(Encoder* _this, byte _flags);
	...
	public static extern unsafe RenderFrameState RenderFrame(int _msecs);
	...
	public static extern unsafe UIntPtr OverrideInternalTexturePtr(TextureHandle _handle, UIntPtr _ptr, ushort _layerIndex);
	...
	public static extern unsafe void SetMarker([MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	...
	public static extern unsafe void SetVertexBufferWithLayout(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	public static extern unsafe void SetDynamicVertexBufferWithLayout(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	public static extern unsafe void SetTransientVertexBufferWithLayout(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	...
	public static extern unsafe void SubmitOcclusionQuery(ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, byte _flags);
	...
	public static extern unsafe void SubmitIndirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, uint _start, uint _num, uint _depth, byte _flags);
	...
	public static extern unsafe void SubmitIndirectCount(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, uint _start, IndexBufferHandle _numHandle, uint _numIndex, uint _numMax, uint _depth, byte _flags);
	...
	public static extern unsafe void DispatchIndirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, uint _start, uint _num, byte _flags);
